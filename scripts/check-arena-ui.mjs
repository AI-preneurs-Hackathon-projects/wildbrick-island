...
check('Previous creations opens the existing collection, clears held input and rebuilds once',()=>{
 ...
 ui.openMenu('pause');assert.equal(document.querySelector('#collection'),null);assert.ok(document.querySelector('#tour-again'));assert.ok(document.querySelector('#type-fallback'));ui.closeMenu();
});
