...
await check('trees and buildings still shield rivals from projectiles',()=>{
 for(const id of ['house:0','tree:inner:0']){
  ...
  Object.assign(a,{kit:makeKit('bow'),x:box.x,z:box.z-8,protectedUntil:0,yaw:0});Object.assign(b,{x:box.x,z:box.z+8,protectedUntil:0});a.kit.muzzle=[-1.1,1.4,1]; // Centered fixture ray must cross the narrow trunk.
