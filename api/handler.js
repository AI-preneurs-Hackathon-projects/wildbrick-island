...
// Production uses the shared Worker's direct OpenAI transport. Legacy
// AI_GATEWAY_* variables are intentionally ignored by this entrypoint.
const productionWorker = worker;

let db;
const handle = createVercelHandler({worker: productionWorker, getDb() {
