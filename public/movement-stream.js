...
export function packFrame(id,i){return [id,i.x||0,i.z||0,i.cameraYaw||0,i.aimPitch||0,(i.sprint?1:0)|(i.up?2:0)|(i.down?4:0)|(i.fire?8:0)|(i.jump?16:0)];}
export function frameInput(f){return {x:f[1],z:f[2],cameraYaw:f[3],aimPitch:f[4],sprint:!!(f[5]&1),up:!!(f[5]&2),down:!!(f[5]&4),fire:!!(f[5]&8),jump:!!(f[5]&16)};}
