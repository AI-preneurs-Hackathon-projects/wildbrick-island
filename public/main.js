...
import {createUI,createVoice,icon} from './ui.js?v=47';
import {gameplayBlocked,bindingLabel} from './action-bindings.js?v=47';
...
import {createArenaUI} from './arena-ui.js?v=47';
