...
export const ARENA_LIMIT=8,RESPAWN_MS=12000,INPUT_STALE_MS=750;
...
function event(room,type,data={}){const e={id:++room.eventId,type,time:room.time,...data};room.events.push(e);if(room.events.length>90)room.events.shift();return e;}
