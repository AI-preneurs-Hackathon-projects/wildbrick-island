...
export function createThemedWorld(root,map){
 ...
 for(let i=0;i<70;i++){const x=Math.sin(i*2.13)*(78+i%7*18),z=Math.cos(i*3.79)*(78+i%9*14);if(Math.abs(x)<62&&Math.abs(z)<62)continue;box(atmosphere,x,-2.2,z,2+i%5,.025,.14,0xcde9e7);}root.add(batchStatic(atmosphere));
