...
export const ACTION_BINDINGS=Object.freeze({
 ...
 lookLeft:{codes:['KeyQ'],label:'Q'},lookRight:{codes:['KeyE'],label:'E'},pitchUp:{codes:['KeyR'],label:'R'},pitchDown:{codes:['KeyF'],label:'F'},collection:{codes:['KeyC'],label:'C',aria:'C'},slot1:{codes:['Digit1'],label:'1',slot:0},slot2:{codes:['Digit2'],label:'2',slot:1},slot3:{codes:['Digit3'],label:'3',slot:2},slot4:{codes:['Digit4'],label:'4',slot:3},slot5:{codes:['Digit5'],label:'5',slot:4},snapshot:{codes:['Digit0','Numpad0'],label:'0',aria:'0'},help:{codes:['KeyH'],label:'H'},menu:{codes:['Escape'],label:'Esc',aria:'Escape'}
});
