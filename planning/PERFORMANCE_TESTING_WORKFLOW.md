...
Current baseline: `42fa6da54b5ef61481b8fe24ad42d86d405fb270`. Yerzhan authorized removing the provisional overlap scheduler while preserving the independent firing fix. Serial behavior is restored and verified; this removes a tradeoff rather than claiming a speedup. The subsequent remote interpolation experiment failed its variable/moderate-delay criteria and was reverted. No remote smoothness gain is retained. The current progress section records exact before/after evidence and the rejected source patch. Manual owner review remains optional and is not required to diagnose or certify this failed candidate.
